...
public interface SystemTimer
{
	...
	/**
	 * Schedule a timer interrupt for <code>timeUnits</code> time units in the
	 * future for the given pricess.
	 */
	void scheduleInterrupt(int timeUnits, PCB pcb);

	/**
	 * Cancel timer interrupt for the given process.
	 */
	void cancelInterrupt(PCB pcb);
}
